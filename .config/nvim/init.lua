...
--]]
-- Custom mapping for kk to enter Normal mode
vim.api.nvim_set_keymap('i', 'kk', '<Esc>:stopinsert<CR>', { noremap = true, silent = true })
  ...
  {                     -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').add {
        ...
        { '<leader>c', group = '[D]ocument' },
        { '<leader>c', group = '[R]ename' },
        { '<leader>c', group = '[S]earch' },
        { '<leader>c', group = '[W]orkspace' },
        { '<leader>c', group = '[T]oggle' },
        { '<leader>c', group = 'Git [H]unk', mode = { 'n', 'v' } },
      }
    end,
